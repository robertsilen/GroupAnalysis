...
# python groupanalysis.py <names of input csv files>
# Data in input file(s) needs to be in same format as "example.cvs"
#
# Add -timeseries to command to compare groups from several files and plot figures. 
#
